...
| ------------------ | ------------- |
| Body text          | 4.5:1 (AA)    |
| Large text (at least 18pt / 24 CSS px, or bold at least 14pt / 18.67 CSS px) | 3:1 (AA) |
| UI components      | 3:1 (AA)      |
| Normal text, enhanced | 7:1 (AAA) |
| Large text, enhanced | 4.5:1 (AAA) |

Apply 4.5:1 at AA to text below the large-text thresholds. See [WCAG contrast guidance](https://www.w3.org/WAI/WCAG22/Understanding/contrast-minimum.html).
